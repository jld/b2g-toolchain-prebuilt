...
#define MASK_THUMB2_FAKE_APCS_FRAME (1 << 16)
...
#define TARGET_THUMB2_FAKE_APCS_FRAME ((target_flags & MASK_THUMB2_FAKE_APCS_FRAME) != 0)
...
enum opt_code
{
  ...
  OPT_mthumb2_fake_apcs_frame,               /* -mthumb2-fake-apcs-frame */
  OPT_mtp_,                                  /* -mtp= */
